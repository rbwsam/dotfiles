...
sudo apt-get install -y --no-install-recommends curl vim git git-delta htop btop jq rsync pigz ncdu lsd bat tree tmux ripgrep glow keychain make unzip direnv
